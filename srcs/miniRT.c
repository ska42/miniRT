...
/*   Updated: 2019/11/05 09:36:01 by lmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int	argc, char *argv[])
{
	...
	/** SQUARE **/
	add_back(&lstobj, TYPE_SQUARE, new_square(new_vector(0, 3, 5), new_vector(0, 0, -1), 1, 0xffff00));
	...
	set_vector(((s_light *)((s_lstobjects *)lstlight->next)->object)->vector, 0, 3, 5);
	add_back(&lstlight, TYPE_LIGHT, new_default_light(TYPE_DIRECTIONAL, 0.2));
	set_vector(((s_light *)((s_lstobjects *)((s_lstobjects *)lstlight->next)->next)->object)->vector, 1, 4, 0);
