...
/*   Updated: 2019/10/31 17:39:01 by lmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int	argc, char *argv[])
{
	...
	lstobj = new_obj(TYPE_SPHERE, new_default_sphere(10, 0xbf3eff));
	set_vector(((s_sphere *)lstobj->object)->center, -75, -75, 200);
	lstobj->next = new_obj(TYPE_SPHERE, new_default_sphere(25, 0x6400));
	set_vector(((s_sphere *)((s_lstobjects *)lstobj->next)->object)->center, 25, 25, 75);
	/** LIGHTS **/
